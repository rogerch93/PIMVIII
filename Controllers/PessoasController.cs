...
namespace PimViii.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(PimViiiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchInt)
        {
            ...
            {
                pessoas = pessoas.Where(s => Convert.ToString(s.Cpf)
            }
        ...
        public async Task<IActionResult> Create([Bind("PessoaId,NomePessoa,Cpf")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PessoaId,NomePessoa,Cpf")] Pessoa pessoa)
        {
